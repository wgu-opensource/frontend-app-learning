...
function add(state, modelType, model, idField) {
    idField = idField !== null && idField !== void 0 ? idField : 'id';
...
function update(state, modelType, model, idField) {
    ...
    state[modelType][id] = Object.assign(Object.assign({}, state[modelType][id]), model);
}
...
export const { addModel, addModels, addModelsMap, updateModel, updateModels, updateModelsMap, removeModel, removeModels, } = slice.actions;
