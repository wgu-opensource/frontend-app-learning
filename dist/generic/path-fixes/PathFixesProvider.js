...
const PathFixesProvider = ({ children }) => {
    ...
    if (location.pathname.includes(' ') || location.pathname.includes('%20')) {
        const newLocation = Object.assign(Object.assign({}, location), { pathname: (location.pathname.replaceAll(' ', '+')).replaceAll('%20', '+') });
        ...
        return (_jsx(Navigate, { to: newLocation, replace: true }));
    }
