...
const UserMessagesProvider = ({ children }) => {
    ...
    function add(message) {
        const { code, dismissible, text, type, topic, payload } = message, others = __rest(message, ["code", "dismissible", "text", "type", "topic", "payload"]);
        const id = refId.current;
        setMessages(currentMessages => [...currentMessages, Object.assign(Object.assign({ code, dismissible, text, type, topic, payload }, others), { id })]);
        refId.current += 1;
    ...
    return (_jsx(UserMessagesContext.Provider, Object.assign({ value: value }, { children: children })));
};
