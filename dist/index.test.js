import { APP_INIT_ERROR, APP_READY, subscribe, } from '@edx/frontend-platform';
...
jest.mock('react', () => (Object.assign(Object.assign({}, jest.requireActual('react')), { StrictMode: 'React Strict Mode' })));
