...
import { fireEvent, initializeTestStore, logUnhandledRequests, render, screen, } from '../../../../setupTest';
...
describe('Notes Visibility', () => {
    ...
    it('hides notes', () => {
        render(_jsx(NotesVisibility, Object.assign({}, mockData)));
    ...
    it('shows notes', () => {
        ...
        render(_jsx(NotesVisibility, Object.assign({}, testData)));
    ...
    it('handles click', () => __awaiter(void 0, void 0, void 0, function* () {
        const mockFn = jest.fn();
        const frame = document.createElement('iframe');
        frame.id = 'unit-iframe';
        const { container } = render(_jsx(NotesVisibility, Object.assign({}, mockData)));
        container.appendChild(frame);
        frame.contentWindow.addEventListener('message', e => {
            mockFn(e.data);
        });
        fireEvent.click(screen.getByRole('switch', { name: 'Show Notes' }));
        yield waitFor(() => expect(mockFn).toHaveBeenCalled());
...
//# sourceMappingURL=NotesVisibility.test.js.map