...
import { sendTrackingLogEvent, sendTrackEvent, } from '@edx/frontend-platform/analytics';
import { useNavigate } from 'react-router-dom';
const JumpNavMenuItem = ({ title, courseId, currentSequence, currentUnit, sequences, isDefault, onClick, }) => {
    ...
    return (_jsx(Dropdown.Item, Object.assign({ active: isDefault, onClick: e => handleClick(e) }, { children: title })));
};
