...
export const iframeBehaviorState = {
    iframeHeight: (val) => useState(val),
    hasLoaded: (val) => useState(val),
    showError: (val) => useState(val),
    windowTopOffset: (val) => useState(val), // eslint-disable-line
};
const useIFrameBehavior = ({ elementId, id, iframeUrl, onLoaded, }) => {
    ...
    React.useEffect(() => {
        ...
        if (hash) {
            ...
            (_a = frame === null || frame === void 0 ? void 0 : frame.contentWindow) === null || _a === void 0 ? void 0 : _a.postMessage({ hashName: hash }, `${getConfig().LMS_BASE_URL}`);
        }
    ...
    const updateIframeVisibility = () => {
        ...
        const rect = iframeElement === null || iframeElement === void 0 ? void 0 : iframeElement.getBoundingClientRect();
        const visibleInfo = {
            type: 'unit.visibilityStatus',
            data: {
                topPosition: rect === null || rect === void 0 ? void 0 : rect.top,
                viewportHeight: window.innerHeight,
            },
        };
        (_a = iframeElement === null || iframeElement === void 0 ? void 0 : iframeElement.contentWindow) === null || _a === void 0 ? void 0 : _a.postMessage(visibleInfo, `${getConfig().LMS_BASE_URL}`);
    };
