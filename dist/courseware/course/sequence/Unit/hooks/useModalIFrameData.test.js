...
jest.mock('react', () => (Object.assign(Object.assign({}, jest.requireActual('react')), { useCallback: jest.fn((cb, prereqs) => ({ cb, prereqs })), useState: jest.fn((initialValue) => [initialValue, jest.fn()]) })));
...
describe('useModalIFrameData', () => {
    ...
    describe('behavior', () => {
        ...
        describe('eventListener', () => {
            ...
            it('consumes modal events and opens sets modal options with open: true', () => {
                ...
                expect(setOptionsCb(oldOptions)).toEqual(Object.assign(Object.assign({}, oldOptions), payload));
            });
    ...
    describe('output', () => {
        ...
        it('forwards modalOptions from state values', () => {
            ...
            expect(useModalIFrameData().modalOptions).toEqual(Object.assign(Object.assign({}, modalOptions), { isOpen: true }));
        });
    });
});
