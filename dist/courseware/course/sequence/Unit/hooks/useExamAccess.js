...
const stateKeys = exports.stateKeys = (0, _reactUnitTestUtils.StrictDict)({
...
const useExamAccess = _ref => {
  ...
  const [blockAccess, setBlockAccess] = (0, _reactUnitTestUtils.useKeyedState)(stateKeys.blockAccess, isExam);
