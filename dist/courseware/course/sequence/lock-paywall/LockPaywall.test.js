...
describe('Lock Paywall', () => {
    ...
    it('displays unlock link with price', () => {
        const { currencySymbol, price, upgradeUrl, } = store.getState().models.courseHomeMeta[mockData.courseId].verifiedMode;
        render(_jsx(LockPaywall, Object.assign({}, mockData)));
    ...
    it('displays discounted price if there is an offer/first time purchase', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        render(_jsx(LockPaywall, Object.assign({}, mockData, { courseId: courseMetadata.id })), { store: testStore });
        expect(screen.getByText(/Upgrade for/).textContent).toMatch('$85 ($100)');
    }));
    it('sends analytics event onClick of unlock link', () => {
        sendTrackEvent.mockClear();
        const { currencySymbol, price, } = store.getState().models.courseHomeMeta[mockData.courseId].verifiedMode;
        render(_jsx(LockPaywall, Object.assign({}, mockData)));
        const upgradeLink = screen.getByRole('link', { name: `Upgrade for ${currencySymbol}${price}` });
    ...
    it('does not display anything if course does not have verified mode', () => __awaiter(void 0, void 0, void 0, function* () {
        const courseHomeMetadata = Factory.build('courseHomeMetadata', { verified_mode: null });
        const testStore = yield initializeTestStore({ courseHomeMetadata, excludeFetchSequence: true }, false);
        render(_jsx(LockPaywall, Object.assign({}, mockData, { courseId: courseHomeMetadata.id })), { store: testStore });
        expect(screen.queryByTestId('lock-paywall-test-id')).not.toBeInTheDocument();
    }));
    it('displays past expiration message if expiration date has expired', () => __awaiter(void 0, void 0, void 0, function* () {
        const courseMetadata = Factory.build('courseMetadata', {
            access_expiration: {
    ...
    it('sends analytics event onClick of past expiration course details link', () => __awaiter(void 0, void 0, void 0, function* () {
        sendTrackEvent.mockClear();
        const courseMetadata = Factory.build('courseMetadata', {
            access_expiration: {
                expiration_date: '1995-02-22T05:00:00Z',
        ...
        const testStore = yield initializeTestStore({ courseMetadata }, false);
        render(_jsx(LockPaywall, Object.assign({}, mockData, { courseId: courseMetadata.id })), { store: testStore });
        const courseDetailsLink = yield screen.getByText('View Course Details');
...
//# sourceMappingURL=LockPaywall.test.js.map