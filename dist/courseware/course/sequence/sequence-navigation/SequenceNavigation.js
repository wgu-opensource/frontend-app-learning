...
const SequenceNavigation = _ref => {
  ...
  const renderPreviousButton = () => {
    ...
    return navigationDisabledPrevSequence || /*#__PURE__*/(0, _jsxRuntime.jsx)(_paragon.Button, {
      variant: "link",
  ...
  const renderNextButton = () => {
    ...
    return navigationDisabledNextSequence || /*#__PURE__*/(0, _jsxRuntime.jsx)(_paragon.Button, {
      variant: "link",
      className: "next-btn",
      onClick: nextHandler,
      disabled: disabled,
...
var _default = exports.default = (0, _i18n.injectIntl)(SequenceNavigation);
