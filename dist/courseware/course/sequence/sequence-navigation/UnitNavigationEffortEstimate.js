 ...
 */
const UnitNavigationEffortEstimate = ({ children, sequenceId, unitId, }) => {
    const intl = useIntl();
    ...
    return (_jsxs("div", Object.assign({ className: "d-inline-block text-wrap" }, { children: [intl.formatMessage(messages.nextUpButton, { title: nextSequence.title }), _jsx(EffortEstimate, { className: "d-block mt-1", block: nextSequence })] })));
};
