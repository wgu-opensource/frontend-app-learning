...
export function useIsSidebarOpen(unitId) {
    ...
    return (currentSidebar === WIDGETS.NOTIFICATIONS) || (currentSidebar === 'DISCUSSIONS_NOTIFICATIONS') || (currentSidebar === WIDGETS.DISCUSSIONS && !!((topic === null || topic === void 0 ? void 0 : topic.id) || (topic === null || topic === void 0 ? void 0 : topic.enabledInContext)));
}
