...
const Chat = ({ enabled, enrollmentMode, isStaff, courseId, contentToolsEnabled, unitId, }) => {
    ...
    if (!enabled || (activeAttempt === null || activeAttempt === void 0 ? void 0 : activeAttempt.attempt_id) || (exam === null || exam === void 0 ? void 0 : exam.id)) {
        return null;
    }
    ...
    const expiration = (accessExpiration === null || accessExpiration === void 0 ? void 0 : accessExpiration.expirationDate) || utcDate;
    const validDate = ((start ? start <= utcDate : true)
    ...
    return createPortal(_jsx(Xpert, { courseId: courseId, contentToolsEnabled: contentToolsEnabled, unitId: unitId, isUpgradeEligible: auditMode }), document.body);
};
Chat.propTypes = {
