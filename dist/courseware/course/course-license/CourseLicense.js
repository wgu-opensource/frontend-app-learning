...
const CourseLicense = ({
  ...
  const renderCreativeCommonsLicense = (activeCreativeCommonsLicenseTags, version) => /*#__PURE__*/(0, _jsxRuntime.jsxs)("a", {
    ...
    }, tag)), intl.formatMessage(_messages.default['learn.course.license.creativeCommons.text']), /*#__PURE__*/(0, _jsxRuntime.jsx)("span", {
      className: "sr-only",
      children: intl.formatMessage(_messages.default['learn.course.license.creativeCommons.externalSite.screenreaderOnly.message'])
    })]
  });
...
var _default = exports.default = CourseLicense;
