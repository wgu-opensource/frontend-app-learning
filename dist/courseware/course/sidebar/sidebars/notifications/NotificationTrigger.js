...
const NotificationTrigger = ({ onClick, }) => {
    const intl = useIntl();
    const { courseId, notificationStatus, setNotificationStatus, upgradeNotificationCurrentState, } = useContext(SidebarContext);
    ...
    return (_jsx(SidebarTriggerBase, Object.assign({ onClick: onClick, ariaLabel: intl.formatMessage(messages.openNotificationTrigger) }, { children: _jsx(NotificationIcon, { status: notificationStatus, notificationColor: "bg-danger-500" }) })));
};
