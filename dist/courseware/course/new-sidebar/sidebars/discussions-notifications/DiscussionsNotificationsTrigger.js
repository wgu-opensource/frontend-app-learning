...
const DiscussionsNotificationsTrigger = ({ onClick }) => {
    const { courseId, currentSidebar, setNotificationStatus, upgradeNotificationCurrentState, isNotificationbarAvailable, isDiscussionbarAvailable, } = useContext(SidebarContext);
    ...
    return (_jsx(IconButton, { src: sidebarIcon, iconAs: Icon, onClick: handleClick, alt: intl.formatMessage(messages.openSidebarTrigger), className: "icon-hover" }));
};
