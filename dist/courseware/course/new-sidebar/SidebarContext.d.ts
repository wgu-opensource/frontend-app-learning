...
export type UpgradeNotificationState = ('accessLastHour' | 'accessHoursLeft' | 'accessDaysLeft' | 'FPDdaysLeft' | 'FPDLastHour' | 'accessDateView' | 'PastExpirationDate');
...
declare const SidebarContext: React.Context<SidebarContextData>;
