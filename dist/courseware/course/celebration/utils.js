...
function recordFirstSectionCelebration(org, courseId, celebrations, dispatch) {
    ...
    dispatch(updateModel({
        ...
        model: {
            id: courseId,
            celebrations: Object.assign(Object.assign({}, celebrations), { firstSection: false }),
        },
    }));
    // Tell our analytics
...
function shouldCelebrateOnSectionLoad(courseId, sequenceId, celebrateFirstSection, dispatch, celebrations) {
    ...
    const { prevSequenceId, nextSequenceId, } = celebrationIds;
...
export { handleNextSectionCelebration, recordFirstSectionCelebration, recordWeeklyGoalCelebration, shouldCelebrateOnSectionLoad, };
