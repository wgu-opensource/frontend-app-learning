...
const RedirectPage = _ref => {
  ...
  switch (mode) {
    case _constants.REDIRECT_MODES.DASHBOARD_REDIRECT:
      ...
      break;
    case _constants.REDIRECT_MODES.ENTERPRISE_LEARNER_DASHBOARD_REDIRECT:
    ...
    case _constants.REDIRECT_MODES.HOME_REDIRECT:
      ...
      break;
    default:
      global.location.assign(`${LMS_BASE_URL}${(0, _reactRouterDom.generatePath)(pattern, {
        courseId
      })}`);
  }
  return null;
...
var _default = exports.default = RedirectPage;
