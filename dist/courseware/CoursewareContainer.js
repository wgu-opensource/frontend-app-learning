...
const checkResumeRedirect = (0, _reselect.defaultMemoize)((courseStatus, courseId, sequenceId, firstSequenceId, navigate) => {
...
const checkSectionUnitToUnitRedirect = (0, _reselect.defaultMemoize)((courseStatus, courseId, sequenceStatus, section, unitId, navigate) => {
...
// Look at where this is called in componentDidUpdate for more info about its usage
const checkSectionToSequenceRedirect = (0, _reselect.defaultMemoize)((courseStatus, courseId, sequenceStatus, section, unitId, navigate) => {
  if (courseStatus === 'loaded' && sequenceStatus === 'failed' && section && !unitId) {
...
// Look at where this is called in componentDidUpdate for more info about its usage
const checkUnitToSequenceUnitRedirect = (0, _reselect.defaultMemoize)((courseStatus, courseId, sequenceStatus, sequenceMightBeUnit, sequenceId, section, routeUnitId, navigate) => {
...
// Look at where this is called in componentDidUpdate for more info about its usage
const checkSequenceToSequenceUnitRedirect = (0, _reselect.defaultMemoize)((courseId, sequenceStatus, sequence, unitId, navigate) => {
...
// Look at where this is called in componentDidUpdate for more info about its usage
const checkSequenceUnitMarkerToSequenceUnitRedirect = (0, _reselect.defaultMemoize)((courseId, sequenceStatus, sequence, unitId, navigate) => {
  ...
  if (unitId === 'first') {
    if (hasUnits) {
      ...
      navigate(`/course/${courseId}/${sequence.id}`, {
        replace: true
      });
    }
  } else if (unitId === 'last') {
...
class CoursewareContainer extends _react.Component {
  ...
  componentDidUpdate() {
    ...
    checkUnitToSequenceUnitRedirect((courseStatus, courseId, sequenceStatus, sequenceMightBeUnit, sequenceId, sectionViaSequenceId, routeUnitId, navigate));
