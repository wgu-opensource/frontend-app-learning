...
exports.getSequenceForUnitDeprecatedUrl = void 0;
...
const getSequenceForUnitDeprecatedUrl = courseId => {
...
exports.getSequenceForUnitDeprecatedUrl = getSequenceForUnitDeprecatedUrl;
...
async function getSequenceMetadata(sequenceId, params) {
  const {
    data
