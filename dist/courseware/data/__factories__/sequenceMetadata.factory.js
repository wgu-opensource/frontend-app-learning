...
Factory.define('sequenceMetadata')
    ...
    .option('sequenceBlock', ['courseId', 'unitBlocks'], (courseId, unitBlocks) => (Factory.build('block', { type: 'sequential', children: unitBlocks.map(unitBlock => unitBlock.id) }, { courseId })))
...
export default function buildSimpleCourseAndSequenceMetadata(options = {}) {
    ...
    const sequenceMetadata = options.sequenceMetadata || sequenceBlocks.map(block => Factory.build('sequenceMetadata', {}, {
    ...
    return Object.assign(Object.assign({}, simpleCourseBlocks), { courseMetadata,
        sequenceMetadata,
        courseHomeMetadata });
}
