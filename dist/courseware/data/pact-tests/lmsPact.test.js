...
import { getCourseMetadata, getLearningSequencesOutline, getSequenceMetadata, postSequencePosition, getBlockCompletion, getResumeBlock, sendActivationEmail, } from '../api';
import { initializeMockApp } from '../../../setupTest';
import { courseId, dateRegex, opaqueKeysRegex, sequenceId, usageId, } from '../../../pacts/constants';
...
describe('Courseware Service', () => {
    ...
    describe('When a request to get a learning sequence outline is made', () => {
        it('returns a normalized outline', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('skips unreleased sequences', () => __awaiter(void 0, void 0, void 0, function* () {
            const normalizedOutline = {
                courses: {
                    'course-v1:edX+DemoX+Demo_Course': {
                        id: 'course-v1:edX+DemoX+Demo_Course',
    ...
    describe('When a request to set sequence position against Unit Index is made', () => {
        it('returns if the request was success or failure', () => __awaiter(void 0, void 0, void 0, function* () {
            setTimeout(() => {
                provider.addInteraction({
    ...
    describe('When a request to get completion block is made', () => {
        it('returns the completion status', () => __awaiter(void 0, void 0, void 0, function* () {
            setTimeout(() => {
                provider.addInteraction({
    ...
    describe('When a request to get resume block is made', () => {
        it('returns block id, section id and unit id of the resume block', () => __awaiter(void 0, void 0, void 0, function* () {
...
//# sourceMappingURL=lmsPact.test.js.map