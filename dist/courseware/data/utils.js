        ...
        switch (block.type) {
            case 'chapter':
                models.sections[block.id] = {
                    ...
                    completionStat: {
                        completed: (_a = block.completion_stat) === null || _a === void 0 ? void 0 : _a.completion,
                        total: (_b = block.completion_stat) === null || _b === void 0 ? void 0 : _b.completable_children,
                    },
                };
                break;
            case 'sequential':
            case 'lock':
                models.sequences[block.id] = {
                    ...
                    completionStat: {
                        completed: (_c = block.completion_stat) === null || _c === void 0 ? void 0 : _c.completion,
                        total: (_d = block.completion_stat) === null || _d === void 0 ? void 0 : _d.completable_children,
                    },
                };
                break;
            case 'vertical':
