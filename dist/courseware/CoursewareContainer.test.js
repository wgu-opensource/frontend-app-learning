...
import CoursewareContainer, { checkResumeRedirect, checkSectionToSequenceRedirect, checkSectionUnitToUnitRedirect, checkSequenceToSequenceUnitRedirect, checkSequenceUnitMarkerToSequenceUnitRedirect, checkUnitToSequenceUnitRedirect, } from './CoursewareContainer';
...
jest.mock('./course/sequence/Unit', 
// eslint-disable-next-line react/prop-types
() => function ({ courseId, id }) {
    return _jsxs("div", Object.assign({ className: "fake-unit" }, { children: ["Unit Contents ", courseId, " ", id] }));
});
...
describe('CoursewareContainer', () => {
    ...
    const { courseBlocks: defaultCourseBlocks, sequenceBlocks: [defaultSequenceBlock], } = buildSimpleCourseBlocks(defaultCourseId, defaultCourseHomeMetadata.title, { unitBlocks: defaultUnitBlocks });
    beforeEach(() => {
        axiosMock = new MockAdapter(getAuthenticatedHttpClient());
        store = initializeStore();
        component = (_jsx(AppProvider, Object.assign({ store: store, wrapWithRouter: false }, { children: _jsx(UserMessagesProvider, { children: _jsx(Routes, { children: DECODE_ROUTES.COURSEWARE.map((route) => (_jsx(Route, { path: route, element: _jsx(CoursewareContainer, {}) }, route))) }) }) })));
    });
    function setUpMockRequests(options = {}) {
        ...
        const sequenceMetadatas = options.sequenceMetadatas || (Object.values(courseBlocks.blocks)
    ...
    function loadContainer() {
        return __awaiter(this, void 0, void 0, function* () {
            const { container } = render(_jsx(BrowserRouter, { children: component }));
    ...
    it('should initialize to show a spinner', () => {
        ...
        render(_jsx(MemoryRouter, Object.assign({ initialEntries: ['/course/abc123'] }, { children: component })));
        const spinner = screen.getByRole('status');
        expect(spinner.firstChild).toContainHTML(`<span class="sr-only">${tabMessages.loading.defaultMessage}</span>`);
    });
    describe('when receiving successful course data', () => {
        ...
        describe('when the URL only contains a course ID', () => {
            ...
            it('should use the resume block response to pick a unit if it contains one', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should use the first sequence ID and activeUnitIndex if the resume block response is empty', () => __awaiter(void 0, void 0, void 0, function* () {
                // set the position to the third unit so we can prove activeUnitIndex is working
                const sequenceMetadata = Factory.build('sequenceMetadata', { position: 3 }, // position index is 1-based and is converted to 0-based for activeUnitIndex
        ...
        describe('when the URL contains a section ID instead of a sequence ID', () => {
            const { courseBlocks, unitTree, sequenceTree, sectionTree, } = buildBinaryCourseBlocks(courseId, courseHomeMetadata.title);
            ...
            describe('when the URL does not contain a unit ID', () => {
                it('should choose a unit within the section\'s first sequence', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            describe('when the section is empty', () => {
                ...
                const blocksWithEmptySection = Object.assign({}, courseBlocks.blocks);
                blocksWithEmptySection[sectionTree[1].id] = Object.assign(Object.assign({}, sectionTree[1]), { children: [] });
                ...
                const courseBlocksWithEmptySection = Object.assign(Object.assign({}, courseBlocks), { blocks: blocksWithEmptySection });
                beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
                    setUpMockRequests({ courseBlocks: courseBlocksWithEmptySection });
                }));
                it('should ignore the section ID and instead redirect to the course root', () => __awaiter(void 0, void 0, void 0, function* () {
                    setUrl(sectionTree[1].id);
                    yield loadContainer();
        ...
        describe('when the URL contains a unit marker', () => {
            it('should redirect /first to the first unit', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should redirect /last to the last unit', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        describe('when the URL contains a course ID and sequence ID', () => {
            const sequenceBlock = defaultSequenceBlock;
            const unitBlocks = defaultUnitBlocks;
            it('should pick the first unit if position was not defined (activeUnitIndex becomes 0)', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should use activeUnitIndex to pick a unit from the sequence', () => __awaiter(void 0, void 0, void 0, function* () {
                const sequenceMetadata = Factory.build('sequenceMetadata', { position: 3 }, // position index is 1-based and is converted to 0-based for activeUnitIndex
                { courseId, unitBlocks, sequenceBlock });
                setUpMockRequests({ sequenceMetadatas: [sequenceMetadata] });
                history.push(`/course/${courseId}/${sequenceBlock.id}`);
        ...
        describe('when the URL contains a course, sequence, and unit ID', () => {
            const sequenceBlock = defaultSequenceBlock;
            const unitBlocks = defaultUnitBlocks;
            it('should load the specified unit', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should render the sequence_navigation plugin slot correctly', () => __awaiter(void 0, void 0, void 0, function* () {
                axiosMock
    ...
    describe('when receiving a course_access error_code', () => {
        function setUpWithDeniedStatus(errorCode) {
            ...
            const courseHomeMetadata = Factory.build('courseHomeMetadata', {
                course_access: {
                    ...
                    additional_context_user_message: 'uhoh oh no',
        ...
        it('should go to course home for an enrollment_required error code', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should go to course survey for a survey_required error code', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should go to consent page for a data_sharing_access_required error code', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should go to access denied page for a incorrect_active_enterprise error code', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should go to course home for an authentication_required error code', () => __awaiter(void 0, void 0, void 0, function* () {
            const { courseMetadata } = setUpWithDeniedStatus('authentication_required');
            yield loadContainer();
            expect(global.location.href).toEqual(`http://localhost/course/${courseMetadata.id}/home`);
        }));
        it('should go to dashboard for an unfulfilled_milestones error code', () => __awaiter(void 0, void 0, void 0, function* () {
            setUpWithDeniedStatus('unfulfilled_milestones');
            yield loadContainer();
            expect(global.location.href).toEqual('http://localhost/redirect/dashboard');
        }));
        it('should go to the dashboard with an attached access_response_error for an audit_expired error code', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should go to the dashboard with a notlive start date for a course_not_started error code', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should go to the enterprise learner dashboard for a course_not_started_enterprise_learner error code', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('isPreview equals true', () => {
        describe('checkSequenceUnitMarkerToSequenceUnitRedirect', () => {
            it('return when sequence is not loaded', () => {
                checkSequenceUnitMarkerToSequenceUnitRedirect('courseId', 'loading', { id: 'sequence_1', unitIds: ['unit_1'] }, 'first', navigate, true);
                expect(navigate).not.toHaveBeenCalled();
            });
            it('return when sequence id is null', () => {
                checkSequenceUnitMarkerToSequenceUnitRedirect('courseId', 'loaded', { id: null, unitIds: ['unit_1'] }, 'first', navigate, true);
                expect(navigate).not.toHaveBeenCalled();
            });
            it('calls navigate with first unit id', () => {
                checkSequenceUnitMarkerToSequenceUnitRedirect('courseId', 'loaded', { id: 'sequence_1', unitIds: ['unit_1', 'unit_2'] }, 'first', navigate, true);
            ...
            it('calls navigate with last unit id', () => {
                checkSequenceUnitMarkerToSequenceUnitRedirect('courseId', 'loaded', { id: 'sequence_1', unitIds: ['unit_1', 'unit_2'] }, 'last', navigate, true);
        ...
        describe('checkSequenceToSequenceUnitRedirect', () => {
            it('calls navigate with next unit id', () => {
                checkSequenceToSequenceUnitRedirect('courseId', 'loaded', { id: 'sequence_1', unitIds: ['unit_1', 'unit_2'], activeUnitIndex: 0 }, null, navigate, true);
                const expectedUrl = '/preview/course/courseId/sequence_1/unit_1';
                expect(navigate).toHaveBeenCalledWith(expectedUrl, { replace: true });
            });
            it('returns when sequence status is loading', () => {
                checkSequenceToSequenceUnitRedirect('courseId', 'loading', { id: 'sequence_1', unitIds: ['unit_1', 'unit_2'], activeUnitIndex: 0 }, null, navigate, true);
                expect(navigate).not.toHaveBeenCalled();
            });
            it('returns when sequence id is null', () => {
                checkSequenceToSequenceUnitRedirect('courseId', 'loading', { unitIds: ['unit_1', 'unit_2'], activeUnitIndex: 0 }, null, navigate, true);
                expect(navigate).not.toHaveBeenCalled();
            });
            it('returns when unit id is defined', () => {
                checkSequenceToSequenceUnitRedirect('courseId', 'loaded', { id: 'sequence_1', unitIds: ['unit_1', 'unit_2'], activeUnitIndex: 0 }, 'unit_2', navigate, true);
                expect(navigate).not.toHaveBeenCalled();
            });
            it('returns when unit ids are undefiend', () => {
                checkSequenceToSequenceUnitRedirect('courseId', 'loaded', { id: 'sequence_1', activeUnitIndex: 0 }, null, navigate, true);
                expect(navigate).not.toHaveBeenCalled();
            });
        });
        describe('checkUnitToSequenceUnitRedirect', () => {
            ...
            it('calls navigate with parentId and sequenceId', () => {
                ...
                checkUnitToSequenceUnitRedirect('loaded', 'courseId', 'failed', true, 'unit_1', false, null, navigate, true);
            ...
            it('calls navigate to course page when sequnce is not unit', () => {
                const getSequenceForUnitDeprecated = jest.fn();
                checkUnitToSequenceUnitRedirect('loaded', 'courseId', 'failed', false, 'unit_1', false, null, navigate, true);
                const expectedUrl = '/course/courseId';
                waitFor(() => {
            ...
            it('returns when course status is loading', () => {
                checkUnitToSequenceUnitRedirect('loading', 'courseId', 'failed', true, 'unit_1', false, null, navigate, true);
                expect(navigate).not.toHaveBeenCalled();
            });
            it('returns when sequence status is not failed', () => {
                checkUnitToSequenceUnitRedirect('loaded', 'courseId', 'loaded', true, 'unit_1', false, null, navigate, true);
                expect(navigate).not.toHaveBeenCalled();
            });
            it('returns when section is defined', () => {
                checkUnitToSequenceUnitRedirect('loaded', 'courseId', 'loaded', true, 'unit_1', true, null, navigate, true);
                expect(navigate).not.toHaveBeenCalled();
            });
            it('returns when routeUnitId is defined', () => {
                checkUnitToSequenceUnitRedirect('loaded', 'courseId', 'loaded', true, 'unit_1', false, 'unit_1', navigate, true);
                expect(navigate).not.toHaveBeenCalled();
            });
        });
        describe('checkSectionUnitToUnitRedirect', () => {
            it('calls navigate with unitId', () => {
                checkSectionUnitToUnitRedirect('loaded', 'courseId', 'failed', true, 'unit_2', navigate, true);
                const expectedUrl = '/preview/course/courseId/unit_2';
                expect(navigate).toHaveBeenCalledWith(expectedUrl, { replace: true });
            });
            it('returns when course status is loading', () => {
                checkSectionUnitToUnitRedirect('loading', 'courseId', 'loaded', true, 'unit_2', navigate, true);
                expect(navigate).not.toHaveBeenCalled();
            });
            it('returns when sequence status is loading', () => {
                checkSectionUnitToUnitRedirect('loaded', 'courseId', 'loaded', true, 'unit_2', navigate, true);
                expect(navigate).not.toHaveBeenCalled();
            });
            it('returns when section is null', () => {
                checkSectionUnitToUnitRedirect('loaded', 'courseId', 'loaded', null, 'unit_2', navigate, true);
                expect(navigate).not.toHaveBeenCalled();
            });
            it('returns when unitId is null', () => {
                checkSectionUnitToUnitRedirect('loaded', 'courseId', 'loaded', true, null, navigate, true);
                expect(navigate).not.toHaveBeenCalled();
            });
        });
        describe('checkResumeRedirect', () => {
            it('calls navigate with unitId', () => {
                ...
                checkResumeRedirect('loaded', 'courseId', null, 'sequence_1', navigate, true);
            ...
            it('returns when course status is loading', () => {
                checkResumeRedirect('loading', 'courseId', null, 'sequence_1', navigate, true);
                expect(navigate).not.toHaveBeenCalled();
            });
            it('returns when sequenceId is defined', () => {
                checkResumeRedirect('loaded', 'courseId', 'sequence_3', 'sequence_1', navigate, true);
                expect(navigate).not.toHaveBeenCalled();
            });
    ...
    describe('isPreview equals false', () => {
        describe('checkSectionToSequenceRedirect', () => {
            it('calls navigate with section based sequence id', () => {
                checkSectionToSequenceRedirect('loaded', 'courseId', 'failed', { sequenceIds: ['sequence_1'] }, null, navigate);
                const expectedUrl = '/course/courseId/sequence_1';
                expect(navigate).toHaveBeenCalledWith(expectedUrl, { replace: true });
            });
            it('calls navigate with course id only', () => {
                checkSectionToSequenceRedirect('loaded', 'courseId', 'failed', { sequenceIds: [] }, null, navigate);
                const expectedUrl = '/course/courseId';
                expect(navigate).toHaveBeenCalledWith(expectedUrl, { replace: true });
            });
            it('returns when course status is loading', () => {
                checkSectionToSequenceRedirect('loading', 'courseId', 'failed', { sequenceIds: [] }, null, navigate);
                expect(navigate).not.toHaveBeenCalled();
            });
            it('returns when sequence status is not failed', () => {
                checkSectionToSequenceRedirect('loaded', 'courseId', 'loading', { sequenceIds: [] }, null, navigate);
                expect(navigate).not.toHaveBeenCalled();
            });
            it('returns when section is not defined', () => {
                checkSectionToSequenceRedirect('loaded', 'courseId', 'failed', null, null, navigate);
                expect(navigate).not.toHaveBeenCalled();
            });
            it('returns when unitId is defined', () => {
                checkSectionToSequenceRedirect('loaded', 'courseId', 'failed', null, 'unit_1', navigate);
                expect(navigate).not.toHaveBeenCalled();
            });
        });
        describe('checkResumeRedirect', () => {
            it('calls navigate with unitId', () => {
                ...
                checkResumeRedirect('loaded', 'courseId', null, 'sequence_1', navigate, false);
                const expectedUrl = '/preview/course/courseId/section_1/unit_1';
                waitFor(() => {
                    expect(navigate).toHaveBeenCalledWith(expectedUrl, { replace: true });
                });
        ...
        describe('checkSequenceUnitMarkerToSequenceUnitRedirect', () => {
            it('calls navigate with first unit id', () => {
                checkSequenceUnitMarkerToSequenceUnitRedirect('courseId', 'loaded', { id: 'sequence_1', unitIds: ['unit_1', 'unit_2'] }, 'first', navigate, false);
                const expectedUrl = '/course/courseId/sequence_1/unit_1';
                expect(navigate).toHaveBeenCalledWith(expectedUrl, { replace: true });
            });
            it('calls navigate with base url when no unit id', () => {
                checkSequenceUnitMarkerToSequenceUnitRedirect('courseId', 'loaded', { id: 'sequence_1', unitIds: [] }, 'first', navigate, true);
                const expectedUrl = '/course/courseId/sequence_1';
                expect(navigate).toHaveBeenCalledWith(expectedUrl, { replace: true });
            });
            it('calls navigate with last unit id', () => {
                checkSequenceUnitMarkerToSequenceUnitRedirect('courseId', 'loaded', { id: 'sequence_1', unitIds: ['unit_1', 'unit_2'] }, 'last', navigate, false);
        ...
        describe('checkSequenceToSequenceUnitRedirect', () => {
            it('calls navigate with next unit id', () => {
                checkSequenceToSequenceUnitRedirect('courseId', 'loaded', { id: 'sequence_1', unitIds: ['unit_1', 'unit_2'], activeUnitIndex: 0 }, null, navigate, false);
                const expectedUrl = '/course/courseId/sequence_1/unit_1';
                expect(navigate).toHaveBeenCalledWith(expectedUrl, { replace: true });
            });
        });
        ...
        describe('checkSectionUnitToUnitRedirect', () => {
            it('calls navigate with unitId', () => {
                checkSectionUnitToUnitRedirect('loaded', 'courseId', 'failed', true, 'unit_2', navigate, false);
...
//# sourceMappingURL=CoursewareContainer.test.js.map