...
exports.default = InstructorToolbar;
...
function getInsightsUrl(courseId) {
  ...
  if (urlBase) {
    urlFull = `${urlBase}/courses`; // This shouldn't actually be missing, at present,
...
function InstructorToolbar(props) {
  ...
  (0, _react.useEffect)(() => {
    setDidMount(true); // Returning this function here will run setDidMount(false) when this component is unmounted
