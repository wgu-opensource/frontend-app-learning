...
exports.getAccessDeniedRedirectUrl = getAccessDeniedRedirectUrl;
...
function getAccessDeniedRedirectUrl(courseId, activeTabSlug, courseAccess, start) {
  let url = null;
  switch (courseAccess.errorCode) {
    ...
    case 'course_not_started':
      ...
      const startDate = new Intl.DateTimeFormat((0, _i18n.getLocale)()).format(new Date(start));
