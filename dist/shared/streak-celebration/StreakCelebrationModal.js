...
function StreakModal(_ref) {
  ...
  const factoid = getRandomFactoid(intl, streakLengthToCelebrate); // eslint-disable-next-line no-unused-vars
  ...
  const discountCode = 'ZGY11119949'; // Negative means "we don't know yet" vs zero meaning no discount available
  ...
  }, [isStreakCelebrationOpen, org, courseId]); // Ask ecommerce to calculate discount savings
