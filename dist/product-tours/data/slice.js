...
const slice = createSlice({
    ...
    reducers: {
        ...
        setTourData: (state, { payload }) => {
            const { courseHomeTourStatus, showCoursewareTour, toursEnabled, } = payload;
...
export const { disableCourseHomeTour, disableCoursewareTour, disableNewUserCourseHomeModal, launchCourseHomeTour, setTourData, } = slice.actions;
