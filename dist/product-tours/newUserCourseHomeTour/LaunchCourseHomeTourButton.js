...
const LaunchCourseHomeTourButton = ({ srOnly }) => {
    ...
    _jsx(_Fragment, { children: toursEnabled && (_jsxs(Button, Object.assign({ variant: "link", size: "inline", className: `p-0 ${srOnly && 'sr-only sr-only-focusable'}`, onClick: handleClick }, { children: [!srOnly && (_jsx(Icon, { src: Compass, className: "mr-2", style: { height: '18px', width: '18px' } })), intl.formatMessage(messages.launchTour)] }))) }));
};
