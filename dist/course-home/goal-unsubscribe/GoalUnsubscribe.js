...
const GoalUnsubscribe = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(HeaderSlot, { showUserDropdown: false }), _jsxs("main", Object.assign({ id: "main-content", className: "container my-5 text-center" }, { children: [isLoading && (_jsx(PageLoading, { srMessage: `${intl.formatMessage(messages.loading)}` })), !isLoading && (_jsx(ResultPage, { error: error, courseTitle: data.courseTitle }))] }))] }));
};
