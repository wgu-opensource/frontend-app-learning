...
const CourseEndAlert = /*#__PURE__*/_react.default.lazy(() => Promise.resolve().then(() => _interopRequireWildcard(require('./CourseEndAlert')))); // period of time (in ms) before end of course during which we alert
