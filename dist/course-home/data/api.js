...
exports.getCoursewareSearchEnabledFlag = getCoursewareSearchEnabledFlag;
...
async function getProgressTabData(courseId, targetUserId) {
  ...
  try {
    ...
    camelCasedData.gradingPolicy.assignmentPolicies = normalizeAssignmentPolicies(camelCasedData.gradingPolicy.assignmentPolicies, camelCasedData.sectionScores);
...
async function getCoursewareSearchEnabledFlag(courseId) {
...
async function searchCourseContentFromAPI(courseId, searchKeyword) {
