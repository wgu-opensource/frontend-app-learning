...
_rosie.Factory.define('outlineTabData').option('courseId', 'course-v1:edX+DemoX+Demo_Course').option('host', 'http://localhost:18000').option('date_blocks', []).attr('course_blocks', ['courseId'], courseId => {
  const {
    courseBlocks
  } = (0, _courseBlocks.buildMinimalCourseBlocks)(courseId);
  return {
...
//# sourceMappingURL=outlineTabData.factory.js.map