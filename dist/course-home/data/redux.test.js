...
describe('Data layer integration tests', () => {
    ...
    const courseHomeAccessDeniedMetadata = Factory.build('courseHomeMetadata', {
        id: courseId,
        course_access: {
            has_access: false,
    ...
    describe('Test fetchDatesTab', () => {
        ...
        it('Should fail to fetch if error occurs', () => __awaiter(void 0, void 0, void 0, function* () {
            axiosMock.onGet(courseMetadataUrl).networkError();
            axiosMock.onGet(`${datesBaseUrl}/${courseId}`).networkError();
            yield executeThunk(thunks.fetchDatesTab(courseId), store.dispatch);
            expect(loggingService.logError).toHaveBeenCalled();
            expect(store.getState().courseHome.courseStatus).toEqual('failed');
        }));
        it('should result in fetch failed if course metadata call errored', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it.each([401, 403, 404])('should result in fetch denied if course access is denied, regardless of dates API status', (errorStatus) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('Test fetchOutlineTab', () => {
        ...
        it.each([401, 403, 404])('should result in fetch denied if course access is denied, regardless of outline API status', (errorStatus) => __awaiter(void 0, void 0, void 0, function* () {
            axiosMock.onGet(courseMetadataUrl).reply(200, courseHomeAccessDeniedMetadata);
    ...
    describe('Test fetchProgressTab', () => {
        ...
        it('Should handle the url including a targetUserId', () => __awaiter(void 0, void 0, void 0, function* () {
            const progressTabData = Factory.build('progressTabData', { courseId });
            const targetUserId = 2;
            const progressUrl = `${progressBaseUrl}/${courseId}/${targetUserId}/`;
            axiosMock.onGet(courseMetadataUrl).reply(200, courseHomeMetadata);
            axiosMock.onGet(progressUrl).reply(200, progressTabData);
            yield executeThunk(thunks.fetchProgressTab(courseId, 2), store.dispatch);
            const state = store.getState();
            expect(state.courseHome.targetUserId).toEqual(2);
        }));
        it.each([401, 403, 404])('should result in fetch denied for expected errors and failed for all others', (errorStatus) => __awaiter(void 0, void 0, void 0, function* () {
            const progressUrl = `${progressBaseUrl}/${courseId}`;
            axiosMock.onGet(courseMetadataUrl).reply(200, courseHomeAccessDeniedMetadata);
    ...
    describe('Test saveCourseGoal', () => {
        it('Should save course goal', () => __awaiter(void 0, void 0, void 0, function* () {
            const goalUrl = `${getConfig().LMS_BASE_URL}/api/course_home/save_course_goal`;
            axiosMock.onPost(goalUrl).reply(200, {});
            yield thunks.deprecatedSaveCourseGoal(courseId, 'unsure');
    ...
    describe('Test resetDeadlines', () => {
        it('Should reset course deadlines', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield executeThunk(thunks.resetDeadlines(courseId, model, getTabDataMock), store.dispatch);
    ...
    describe('Test dismissWelcomeMessage', () => {
        it('Should dismiss welcome message', () => __awaiter(void 0, void 0, void 0, function* () {
            const dismissUrl = `${getConfig().LMS_BASE_URL}/api/course_home/dismiss_welcome_message`;
            axiosMock.onPost(dismissUrl).reply(201);
            yield executeThunk(thunks.dismissWelcomeMessage(courseId), store.dispatch);
    ...
    describe('Test fetchCoursewareSearchSettings', () => {
        it('Should return enabled as true when enabled', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const { enabled } = yield thunks.fetchCoursewareSearchSettings(courseId);
            expect(axiosMock.history.get[0].url).toEqual(apiUrl);
            expect(enabled).toBe(true);
        }));
        it('Should return enabled as false when disabled', () => __awaiter(void 0, void 0, void 0, function* () {
            const apiUrl = `${getConfig().LMS_BASE_URL}/courses/${courseId}/courseware-search/enabled/`;
        ...
        it('Should return enabled as false on error', () => __awaiter(void 0, void 0, void 0, function* () {
            const apiUrl = `${getConfig().LMS_BASE_URL}/courses/${courseId}/courseware-search/enabled/`;
