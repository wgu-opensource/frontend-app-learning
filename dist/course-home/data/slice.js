...
import { LOADING, LOADED, FAILED, DENIED, } from '@src/constants';
...
export const { fetchProctoringInfoResolved, fetchTabDenied, fetchTabFailure, fetchTabRequest, fetchTabSuccess, setCallToActionToast, setShowSearch, } = slice.actions;
