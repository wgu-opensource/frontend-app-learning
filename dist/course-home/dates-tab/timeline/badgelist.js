...
function getBadgeListAndColor(date, intl, item, items) {
    ...
    const badges = (_jsx(_Fragment, { children: badgesInfo.map(b => {
            ...
            return (_jsxs(Badge, Object.assign({ className: classNames('ml-2', b.bg, b.className), "data-testid": "dates-badge" }, { children: [b.icon && _jsx(FontAwesomeIcon, { icon: b.icon, className: "mr-1" }), intl.formatMessage(b.message)] }), b.message.id));
        }) }));
    if (!color && isInFuture) {
        color = 'bg-gray-900';
    }
