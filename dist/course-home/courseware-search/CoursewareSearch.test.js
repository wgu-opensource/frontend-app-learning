...
import { initializeMockApp, render, screen, waitFor, fireEvent, within, } from '../../setupTest';
...
jest.mock('./hooks');
jest.mock('../../generic/model-store', () => (Object.assign(Object.assign({}, jest.requireActual('../../generic/model-store')), { updateModel: jest.fn(), useModel: jest.fn() })));
...
function renderComponent(props = {}) {
    ...
    const { container } = render(_jsx(AppProvider, Object.assign({ store: store }, { children: _jsx(Routes, { children: _jsx(Route, { path: "/course/:courseId/:sequenceId/:unitId", element: _jsx(CoursewareSearch, Object.assign({ intl: intl }, props)) }) }) })));
    return container;
}
const mockModels = ((props = defaultProps) => {
    useModel.mockReturnValue(Object.assign(Object.assign({}, defaultProps), props));
...
const mockSearchParams = ((params) => {
    const props = Object.assign(Object.assign({}, defaultSearchParams), params);
...
describe('CoursewareSearch', () => {
    ...
    describe('when clicking on the "Close" button', () => {
        it('should close the dialog', () => __awaiter(void 0, void 0, void 0, function* () {
            renderComponent();
            yield waitFor(() => {
    ...
    describe('when submitting an empty search', () => {
        it('should clear the search by dispatch updateModel', () => __awaiter(void 0, void 0, void 0, function* () {
            renderComponent();
            yield waitFor(() => {
    ...
    describe('when submitting a search', () => {
        ...
        it('should call searchCourseContent', () => __awaiter(void 0, void 0, void 0, function* () {
            renderComponent();
...
//# sourceMappingURL=CoursewareSearch.test.js.map