...
export default function mapSearchResponse(response, searchKeywords = '') {
    ...
    const { took: ms, total, maxScore, results: rawResults, } = data;
    const results = rawResults.map(result => {
        const { score, data: { id, content: { displayName, htmlContent, transcriptEn, }, contentType, location, url, }, } = result;
        const type = (contentType === null || contentType === void 0 ? void 0 : contentType.toLowerCase()) || defaultType;
    ...
    const filters = rawResults.reduce((list, result) => {
        var _a;
        const label = (_a = result === null || result === void 0 ? void 0 : result.data) === null || _a === void 0 ? void 0 : _a.contentType;
        if (!label) {
            return list;
        }
        ...
        const newItem = Object.assign({}, list[index]);
        newItem.count++;
