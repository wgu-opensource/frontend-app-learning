...
import { fireEvent, initializeMockApp, logUnhandledRequests, render, screen, act, } from '../../setupTest';
...
describe('Progress Tab', () => {
    ...
    function fetchAndRender() {
        return __awaiter(this, void 0, void 0, function* () {
            yield executeThunk(thunks.fetchProgressTab(courseId), store.dispatch);
            yield act(() => __awaiter(this, void 0, void 0, function* () { return render(_jsx(ProgressTab, {}), { store }); }));
        });
    }
    ...
    describe('Related links', () => {
        ...
        it('sends event on click of dates tab link', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('sends event on click of outline tab link', () => __awaiter(void 0, void 0, void 0, function* () {
            yield fetchAndRender();
            sendTrackEvent.mockClear();
    ...
    describe('Course Grade', () => {
        it('renders Course Grade', () => __awaiter(void 0, void 0, void 0, function* () {
            yield fetchAndRender();
        ...
        it('renders correct copy in CourseGradeFooter for non-passing', () => __awaiter(void 0, void 0, void 0, function* () {
            setTabData({
                course_grade: {
                    is_passing: false,
                    letter_grade: null,
        ...
        it('renders correct copy in CourseGradeFooter for passing with pass/fail grade range', () => __awaiter(void 0, void 0, void 0, function* () {
            yield fetchAndRender();
            expect(screen.queryByRole('button', { name: 'Grade range tooltip' })).not.toBeInTheDocument();
            expect(screen.getByText('You’re currently passing this course')).toBeInTheDocument();
        }));
        it('renders correct copy and tooltip in CourseGradeFooter for non-passing with letter grade range', () => __awaiter(void 0, void 0, void 0, function* () {
            setTabData({
                course_grade: {
                    is_passing: false,
                    letter_grade: null,
        ...
        it('renders correct copy and tooltip in CourseGradeFooter for passing with letter grade range', () => __awaiter(void 0, void 0, void 0, function* () {
            setTabData({
                course_grade: {
                    is_passing: true,
                    letter_grade: 'B',
            ...
            expect(yield screen.findByText('You’re currently passing this course with a grade of B (80-90%)')).toBeInTheDocument();
        }));
        it('renders tooltip in CourseGradeFooter for grade range', () => __awaiter(void 0, void 0, void 0, function* () {
            setTabData({
                course_grade: {
                    percent: 0,
                    is_passing: false,
            ...
            yield fetchAndRender();
            const tooltip = yield screen.getByRole('button', { name: 'Grade range tooltip' });
        ...
        it('renders locked feature preview (CourseGradeHeader) with upgrade button when user has locked content', () => __awaiter(void 0, void 0, void 0, function* () {
            setTabData({
                completion_summary: {
                    complete_count: 1,
                    incomplete_count: 1,
        ...
        it('sends events on click of upgrade button in locked content header (CourseGradeHeader)', () => __awaiter(void 0, void 0, void 0, function* () {
            setTabData({
                completion_summary: {
                    complete_count: 1,
                    incomplete_count: 1,
        ...
        it('renders locked feature preview with no upgrade button when user has locked content but cannot upgrade', () => __awaiter(void 0, void 0, void 0, function* () {
            setTabData({
                completion_summary: {
                    complete_count: 1,
                    incomplete_count: 1,
        ...
        it('does not render locked feature preview when user does not have locked content', () => __awaiter(void 0, void 0, void 0, function* () {
            yield fetchAndRender();
            expect(screen.queryByText('locked feature')).not.toBeInTheDocument();
        }));
        it('renders limited feature preview with upgrade button when user has access to some content that would typically be locked', () => __awaiter(void 0, void 0, void 0, function* () {
            setTabData({
                completion_summary: {
                    complete_count: 1,
                    incomplete_count: 1,
            ...
            expect(screen.queryAllByText('You have limited access to graded assignments as part of the audit track in this course.', { exact: false })).toHaveLength(2);
            expect(screen.queryAllByTestId('locked-icon')).toHaveLength(4);
        }));
        it('does not render subsections for which showGrades is false', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('renders correct title when credit information is available', () => __awaiter(void 0, void 0, void 0, function* () {
            setTabData({
        ...
        it('does not render ungraded subsections when SHOW_UNGRADED_ASSIGNMENT_PROGRESS is false', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('renders both graded and ungraded subsections when SHOW_UNGRADED_ASSIGNMENT_PROGRESS is true', () => __awaiter(void 0, void 0, void 0, function* () {
            // The second assignment has has_graded_assignment set to false.
            setConfig(Object.assign(Object.assign({}, getConfig()), { SHOW_UNGRADED_ASSIGNMENT_PROGRESS: true }));
            setTabData({
                section_scores: [
                    {
                        display_name: 'First section',
            ...
            setConfig(Object.assign(Object.assign({}, getConfig()), { SHOW_UNGRADED_ASSIGNMENT_PROGRESS: false }));
        }));
    });
    describe('Grade Summary', () => {
        it('renders Grade Summary table when assignment policies are populated', () => __awaiter(void 0, void 0, void 0, function* () {
            yield fetchAndRender();
            expect(screen.getByText('Grade summary')).toBeInTheDocument();
        }));
        it('does not render Grade Summary when assignment type grade summary is not populated', () => __awaiter(void 0, void 0, void 0, function* () {
            setTabData({
        ...
        it('shows lock icon when all subsections of assignment type are hidden', () => __awaiter(void 0, void 0, void 0, function* () {
            setTabData({
                grading_policy: {
                    assignment_policies: [
                        {
        ...
        it('shows percent plus hidden grades when some subsections of assignment type are hidden', () => __awaiter(void 0, void 0, void 0, function* () {
            setTabData({
                grading_policy: {
                    assignment_policies: [
                        {
        ...
        it('displays a warning message with the latest due date when not all assignment scores are included in the total grade', () => __awaiter(void 0, void 0, void 0, function* () {
            setTabData({
                grading_policy: {
                    assignment_policies: [
                        {
            ...
            expect(screen.getByText(`Some assignment scores are not yet included in your total grade. These grades will be released by ${formattedDateTime}.`)).toBeInTheDocument();
        }));
        it('renders override notice', () => __awaiter(void 0, void 0, void 0, function* () {
            setTabData({
                section_scores: [
                    {
                        display_name: 'First section',
    ...
    describe('Detailed Grades', () => {
        it('renders Detailed Grades table when section scores are populated', () => __awaiter(void 0, void 0, void 0, function* () {
            yield fetchAndRender();
        ...
        it('sends event on click of subsection link', () => __awaiter(void 0, void 0, void 0, function* () {
            yield fetchAndRender();
            sendTrackEvent.mockClear();
            expect(screen.getByText('Detailed grades')).toBeInTheDocument();
        ...
        it('sends event on click of course outline link', () => __awaiter(void 0, void 0, void 0, function* () {
            yield fetchAndRender();
            sendTrackEvent.mockClear();
            expect(screen.getByText('Detailed grades')).toBeInTheDocument();
        ...
        it('renders individual problem score drawer', () => __awaiter(void 0, void 0, void 0, function* () {
            sendTrackEvent.mockClear();
            yield fetchAndRender();
            expect(screen.getByText('Detailed grades')).toBeInTheDocument();
        ...
        it('render message when section scores are not populated', () => __awaiter(void 0, void 0, void 0, function* () {
            setTabData({
                section_scores: [],
            });
            yield fetchAndRender();
    ...
    describe('Certificate Status', () => {
        ...
        describe('enrolled user', () => {
            ...
            it('Displays text for nonPassing case when learner does not have a passing grade', () => __awaiter(void 0, void 0, void 0, function* () {
                yield fetchAndRender();
                expect(screen.getByText('In order to qualify for a certificate, you must have a passing grade.')).toBeInTheDocument();
            }));
            it('sends event when visiting progress tab when learner is not passing', () => __awaiter(void 0, void 0, void 0, function* () {
                yield fetchAndRender();
                expect(sendTrackEvent).toHaveBeenCalledTimes(1);
            ...
            it('Displays text for inProgress case when more content is scheduled and the learner does not have a passing grade', () => __awaiter(void 0, void 0, void 0, function* () {
                setTabData({
            ...
            it('sends event when visiting progress tab when user has scheduled content', () => __awaiter(void 0, void 0, void 0, function* () {
                setTabData({
                    has_scheduled_content: true,
                });
                yield fetchAndRender();
            ...
            it('sends events on view of progress tab and on click of request certificate link', () => __awaiter(void 0, void 0, void 0, function* () {
                setTabData({
                    certificate_data: { cert_status: 'requesting' },
                    user_has_passing_grade: true,
                });
            ...
            it('sends events on view of progress tab and on click of ID verification link', () => __awaiter(void 0, void 0, void 0, function* () {
                setTabData({
                    certificate_data: { cert_status: 'unverified' },
                    user_has_passing_grade: true,
                    verification_data: { link: 'test' },
            ...
            it('sends event when visiting progress tab with ID verification pending message', () => __awaiter(void 0, void 0, void 0, function* () {
                setTabData({
                    certificate_data: { cert_status: 'unverified' },
                    verification_data: { status: 'pending' },
                    user_has_passing_grade: true,
            ...
            it('sends events on view of progress tab and on click of view certificate link', () => __awaiter(void 0, void 0, void 0, function* () {
                setTabData({
                    certificate_data: {
                        cert_status: 'downloadable',
                        cert_web_view_url: '/certificates/cooluuidgoeshere',
            ...
            it('sends event when visiting the progress tab when cert is earned but unavailable', () => __awaiter(void 0, void 0, void 0, function* () {
                setTabData({
                    certificate_data: { cert_status: 'earned_but_not_available' },
                    user_has_passing_grade: true,
                });
            ...
            it('sends event with correct grade variant for passing with letter grades', () => __awaiter(void 0, void 0, void 0, function* () {
                setTabData({
                    certificate_data: { cert_status: 'earned_but_not_available' },
                    grading_policy: {
                        assignment_policies: [
            ...
            it('sends events on view of progress tab and when audit learner clicks upgrade link', () => __awaiter(void 0, void 0, void 0, function* () {
                setTabData({
                    certificate_data: { cert_status: 'audit_passing' },
                    verified_mode: {
                        upgrade_url: 'http://localhost:18130/basket/add/?sku=8CF08E5',
            ...
            it('sends event when visiting the progress tab even when audit user cannot upgrade (i.e. certificate component does not render)', () => __awaiter(void 0, void 0, void 0, function* () {
                setTabData({
                    certificate_data: { cert_status: 'audit_passing' },
                });
                yield fetchAndRender();
            ...
            it('Does not display the certificate component if it does not match any statuses', () => __awaiter(void 0, void 0, void 0, function* () {
                setTabData({
                    certificate_data: {
            ...
            it('sends event when visiting progress tab, although no certificate statuses match', () => __awaiter(void 0, void 0, void 0, function* () {
                setTabData({
                    certificate_data: {
                        cert_status: 'bogus_status',
                    },
        ...
        it('Does not display the certificate component if the user is not enrolled', () => __awaiter(void 0, void 0, void 0, function* () {
            yield fetchAndRender();
            expect(screen.queryByTestId('certificate-status-component')).not.toBeInTheDocument();
        }));
    ...
    describe('Credit Information', () => {
        it('renders credit information when provided', () => __awaiter(void 0, void 0, void 0, function* () {
            setTabData({
                credit_course_requirements: {
                    eligibility_status: 'eligible',
                    requirements: [
        ...
        it('does not render credit information when it is not provided', () => __awaiter(void 0, void 0, void 0, function* () {
            yield fetchAndRender();
    ...
    describe('Access expiration masquerade banner', () => {
        it('renders banner when masquerading as a user', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield executeThunk(thunks.fetchProgressTab(courseId), store.dispatch);
            yield act(() => __awaiter(void 0, void 0, void 0, function* () { return render(_jsx(LoadedTabPage, Object.assign({ courseId: courseId, activeTabSlug: "progress" }, { children: "..." })), { store }); }));
    ...
    describe('Viewing progress page of other students by changing url', () => {
        it('Changing the url changes the header', () => __awaiter(void 0, void 0, void 0, function* () {
            setMetadata({ is_enrolled: true });
            setTabData({ username: 'otherstudent' });
            yield executeThunk(thunks.fetchProgressTab(courseId, 10), store.dispatch);
            yield act(() => __awaiter(void 0, void 0, void 0, function* () { return render(_jsx(ProgressTab, {}), { store }); }));
            expect(screen.getByText('Course progress for otherstudent')).toBeInTheDocument();
        }));
    });
});
//# sourceMappingURL=ProgressTab.test.js.map