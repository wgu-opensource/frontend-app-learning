...
var _ProgressCertificateStatusSlot = _interopRequireDefault(require("../../../plugin-slots/ProgressCertificateStatusSlot"));
...
const CertificateStatus = () => {
  ...
  const mode = (0, _utils.getCourseExitMode)(certificateData, hasScheduledContent, isEnrolled, userHasPassingGrade, null,
    ...
    switch (certStatus) {
      ...
      default:
        ...
        if (!canViewCertificate) {
          ...
          endDate = intl.formatDate(certificateAvailableDate || end, _objectSpread({
            year: 'numeric',
            month: 'long',
            day: 'numeric'
          }, timezoneFormatArgs));
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)("section", {
    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_paragon.Card, {
      className: "bg-light-200 raised-card",
      children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_ProgressCertificateStatusSlot.default, {
        courseId: courseId,
        children: /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
          id: `${certCase}_certificate_status`,
...
var _default = exports.default = CertificateStatus;
