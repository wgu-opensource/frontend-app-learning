...
const TabContainer = (props) => {
    const { children, fetch, slice, tab, isProgressTab, } = props;
    ...
    return (_jsxs(TabPage, Object.assign({ activeTabSlug: tab, courseId: courseId, courseStatus: courseStatus, metadataModel: `${slice}Meta` }, { children: [courseId && _jsx(OuterExamTimer, { courseId: courseId }), children] })));
};
