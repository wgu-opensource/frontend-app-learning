...
function LoadedTabPage(_ref) {
  ...
  const {
    ...
    title,
    verifiedMode
  } = (0, _modelStore.useModel)('courseHomeMeta', courseId); // Logistration and enrollment alerts are only really used for the outline tab, but loaded here to put them above
